      ...
      instructions: totalUnresolved === 0
        ...
        : {
          ...
          workflow: [
            ...
            '5. Reply to and resolve each thread using: ~/.claude/skills/addressing-pr-comments/scripts/respond-to-thread.js',
            '6. After force pushing, update any previously posted commit links: ~/.claude/skills/managing-stacked-prs/scripts/update-pr-comment-links.mjs',
          ],
