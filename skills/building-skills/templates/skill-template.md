...
# argument-hint: "[optional-args]"  # Shown during autocomplete; use $ARGUMENTS or $1, $2 in content to reference
# allowed-tools: Read, Grep          # Optional: restrict which tools this skill can use
# model: sonnet                       # Optional: specify model for this skill
# context: fork                       # Optional: run in a separate subagent context
---
